...
- [Executive AI Assistant](#executive-ai-assistant)
  ...
  - [Run locally](#run-locally)
    - [Set up EAIA locally](#set-up-eaia-locally)
    - [Ingest Emails Locally](#ingest-emails-locally)
    - [Set up Agent Inbox with Local EAIA](#set-up-agent-inbox-with-local-eaia)
  - [Run in production (LangGraph Cloud)](#run-in-production-langgraph-cloud)
    - [Set up EAIA on LangGraph Cloud](#set-up-eaia-on-langgraph-cloud)
    - [Ingest manually](#ingest-manually)
    - [Set up Agent Inbox with LangGraph Cloud EAIA](#set-up-agent-inbox-with-langgraph-cloud-eaia)
...
Supported embeddings providers and their required packages:
